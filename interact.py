...
class Interact:
    ...
    def main_program(self):
        ...
        while repeat == 'yes':
            ...
            # let's try setting a different confidence level
            # improving model
            horizons = [2,5,60,250,1000]
            backtesting = mydata.add_trends(mymodel, horizons)
            # testing again
            # providing results
            # correlating indices that are open over night before the US markets are open
            # correlate the news
            # increase resolution: hourly or minute data
